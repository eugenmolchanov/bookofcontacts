...
function contactValidation() {
    ...
    if (nationality.length > 255 || (nationality.toString()).search(/[0-9~@#$%^&*.()_+|>?\/<":}!№;,]/) != -1) {
    ...
    if (employmentPlace.length > 255 || /[~@#$%^&/.*()_+|?><:}!№;,]/.test(employmentPlace.toString())) {

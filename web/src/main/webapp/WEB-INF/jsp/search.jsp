...
<form action="/controller" method="post" onsubmit="return search()">
    ...
    <div id="secondLine">
        ...
        <input type="text" name="birthdayFrom" id="birthdayFrom" onfocus="this.type = 'date'" onblur="if(this.value==''){this.type='text'}"
               placeholder="<fmt:message key="birthday"/> " class="form-control"/>
        <input type="text" name="birthdayTo" id="birthdayTo" onfocus="this.type = 'date'" onblur="if(this.value==''){this.type='text'}"
               placeholder="<fmt:message key="birthday"/> " class="form-control"/>
